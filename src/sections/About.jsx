...
export default function About() {
  return (
    <section
      id="about"
      className="h-screen max-h-screen snap-start overflow-hidden bg-bg-darker text-fg flex flex-col items-center justify-start py-8 px-4 sm:px-8 md:px-12 xl:px-20 relative"
    >
